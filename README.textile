...
If you would like to hack on formtastic you should write specs for the changes make if you would like any chance of having the additions merged into the main plugin. To run the specs you will need to install following test depedency gems

<pre>
sudo gem install technicalpickles-jeweler hpricot rspec_hpricot_matchers
</pre>
and possible this too
<pre>
